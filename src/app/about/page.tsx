      ...
      <div className="flex flex-col">
          ...
          <div className="flex flex-col pt-20 md:pt-0 xl:pt-32 pb-12 lg:pb-0 lg:flex-row items-center justify-center">
            ...
            <div className="mx-10 lg:mx-16 lg:w-2/5 text-center lg:text-left">
              ...
              <p className="hidden md:flex my-4 font-roboto">
                ...
                and businesses that I work with; seeking smarter and newer ways
                to do old things while saving time and resources at the same
                time. I'm enthusiastic about OSS.
              </p>
              <p className="hidden lg:flex text-bensongrey font-roboto">
                Highly skilled in Experience Design(xD), Customer
                Experience(Cx), automation, and Developer Experience(Dx)
                Engineering.
              </p>
            </div>
          </div>
        ...
        <div className="flex flex-col w-full lg:flex-row px-12 py-20 items-center bg-bensonpink xl:h-screen text-white font-roboto">
          <div className="md:mx-10 font-roboto">
            ...
            <p className="my-4">
              I am currently the Associate Director of Engineering at 350.org -
              an international environmental organization that focuses on
              addressing climate change issues and promoting sustainable
              solutions by engaging and empowering individuals, communities, and
              ...
              infrastructure to achieve its mission of building a global
            ...
            <p>
              ...
              lasted until November 2020. Thereafter I worked as the Consultant
              Chief Technology Officer of the Nyuma Harrison Foundation (NHF) -
              a Zambian Not-for-profit focused on making healthcare accessible
              to children in underserved communities in Zambia.
            </p>
          </div>
          <div className="md:mx-10 mt-8 md:mt-0">
            ...
            <p className="my-4">
              ...
              representation by connecting them with experienced and qualified
              pro bono lawyers.
            </p>
            <p>
